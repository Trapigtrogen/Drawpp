...
const Color colors::orange      = Color(251, 153, 2);
const Color colors::cyan        = Color(0, 255, 255);
const Color colors::purple      = Color(160, 32, 240);
const Color colors::brown       = Color(150, 75, 0);
const Color colors::magenta     = Color(255, 0, 255);
const Color colors::pink        = Color(255, 105, 180);
const Color colors::violet      = Color(134, 1, 175);
const Color colors::maroon      = Color(128, 0, 0);
const Color colors::turquoise   = Color(64, 224, 208);
const Color colors::lime        = Color(191, 255, 0);
const Color colors::teal        = Color(0, 128, 128);
const Color colors::indigo      = Color(111, 0, 255);
